...
namespace marcatel_api.Controllers
{
    ...
    public class DetalleMapeosController: ControllerBase
    {
        ...
        public DetalleMapeosController(MapeosService mapeoservice, ILogger<MapeosController> logger, IJwtAuthenticationService authService) {
        ...
        [HttpPost("Delete")]
        public JsonResult DeleteDetalleMapeo([FromBody] RenglonMapeoModel mapeo)
        {
            var objectResponse = Helper.GetStructResponse();
            try
            {
                var CatClienteResponse = _mapeoService.DeleteDetalleMapeo(mapeo.Id);
        ...
        [HttpPost("Get")]
        public JsonResult GetDetalleMapeo([FromBody] GetDetalleMapeoreq mapeo)
        {
            var objectResponse = Helper.GetStructResponse();
            try
            {
